...
public:
    ...
    // Play a move
    void PlayMove( Move imove , bool histPush = true);
    ...
    bool AttackedSquare( Square square, bool enemy_is_white, bool = false);
    ...
    static void GenLegalMoveList(std::vector<Move> &moves );
